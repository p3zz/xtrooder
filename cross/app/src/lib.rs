...
mod tests {
    ...
    #[init]
    fn init() -> (Stepper<'static>, Stepper<'static>) {
    ...
    #[test]
    fn test_stepper_move_clockwise(s: &mut (Stepper<'static>, Stepper<'static>)) {
        let steps = 20;
        s.0.reset();
    ...
    #[test]
    fn test_stepper_move_counterclockwise(s: &mut (Stepper<'static>, Stepper<'static>)) {
        let steps = 20;
        s.0.reset();
    ...
    #[test]
    fn test_stepper_move_microstepping_clockwise(s: &mut (Stepper<'static>, Stepper<'static>)) {
        let steps = 20;
        s.0.reset();
    ...
    #[test]
    fn test_stepper_move_microstepping_counterclockwise(s: &mut (Stepper<'static>, Stepper<'static>)) {
        let steps = 20;
        s.0.reset();
        s.0.set_stepping_mode(SteppingMode::HalfStep);
        s.0.set_direction(RotationDirection::CounterClockwise);
    ...
    #[test]
    fn test_stepper_move_clockwise_positive_direction_clockwise(s: &mut (Stepper<'static>, Stepper<'static>)) {
        let steps = 20;
        s.0.reset();
    ...
    #[test]
    fn test_stepper_move_clockwise_positive_direction_counterclockwise(s: &mut (Stepper<'static>, Stepper<'static>)) {
        let steps = 20;
        s.0.reset();
        s.0.set_stepping_mode(SteppingMode::FullStep);
        s.0.set_direction(RotationDirection::Clockwise);
    ...
    #[test]
    fn test_stepper_move_counterclockwise_positive_direction_clockwise(s: &mut (Stepper<'static>, Stepper<'static>)) {
        let steps = 20;
        s.0.reset();
        s.0.set_stepping_mode(SteppingMode::FullStep);
        s.0.set_direction(RotationDirection::CounterClockwise);
    ...
    #[test]
    fn test_stepper_move_counterclockwise_positive_direction_counterclockwise(s: &mut (Stepper<'static>, Stepper<'static>)) {
        let steps = 20;
        s.0.reset();
        s.0.set_stepping_mode(SteppingMode::FullStep);
        s.0.set_direction(RotationDirection::CounterClockwise);
    ...
    #[test]
    fn test_stepper_move_for_distance_no_attachment(s: &mut (Stepper<'static>, Stepper<'static>)) {
    ...
    #[test]
    fn test_stepper_move_for_distance(s: &mut (Stepper<'static>, Stepper<'static>)) {
    ...
    #[test]
    fn test_stepper_move_for_distance_space_wasted(s: &mut (Stepper<'static>, Stepper<'static>)) {
    ...
    #[test]
    fn test_stepper_move_for_distance_lower_distance_per_step(s: &mut (Stepper<'static>, Stepper<'static>)) {
        let distance = Distance::from_mm(10.5);
        s.0.reset();
    ...
    #[test]
    fn test_stepper_move_for_steps_outofbounds(s: &mut (Stepper<'static>, Stepper<'static>)) {
        let steps = 10;
        s.0.reset();
        s.0.set_stepping_mode(SteppingMode::FullStep);
        s.0.set_direction(RotationDirection::CounterClockwise);
    ...
    #[test]
    fn test_stepper_home(s: &mut (Stepper<'static>, Stepper<'static>)) {
        let steps = 10;
        s.0.reset();
        s.0.set_stepping_mode(SteppingMode::FullStep);
    ...
    #[test]
    fn test_stepper_home_no_attachment(s: &mut (Stepper<'static>, Stepper<'static>)) {
        s.0.reset();
        s.0.set_stepping_mode(SteppingMode::FullStep);
    ...
    #[test]
    fn test_stepper_set_speed_positive(s: &mut (Stepper<'static>, Stepper<'static>)) {
        s.0.reset();
        s.0.set_stepping_mode(SteppingMode::FullStep);
    ...
    #[test]
    fn test_stepper_set_speed_zero(s: &mut (Stepper<'static>, Stepper<'static>)) {
        s.0.reset();
        s.0.set_stepping_mode(SteppingMode::FullStep);
    ...
    #[test]
    fn test_stepper_set_speed_negative(s: &mut (Stepper<'static>, Stepper<'static>)) {
        s.0.reset();
        s.0.set_stepping_mode(SteppingMode::FullStep);
    ...
    #[test]
    fn test_linear_move_to_2d_different_stepping_mode(s: &mut (Stepper<'static>, Stepper<'static>)) {
        let destination = Vector2D::new(Distance::from_mm(-5.0), Distance::from_mm(5.0));
        let speed = Speed::from_mm_per_second(10.0);
        s.0.reset();
        s.1.reset();
